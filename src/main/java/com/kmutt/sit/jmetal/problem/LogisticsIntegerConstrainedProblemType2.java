...
public class LogisticsIntegerConstrainedProblemType2 extends AbstractIntegerProblem implements ConstrainedProblem<IntegerSolution> {
	...
	private Logger logger = LoggerFactory.getLogger(LogisticsIntegerConstrainedProblemType2.class);
	...
	public LogisticsIntegerConstrainedProblemType2(NsgaIIIHelper helper) {
